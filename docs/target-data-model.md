...
> Архивный проект модели до добавления загрузок, доступа и версий результатов.
> Не используйте эту схему для миграций. Текущие сущности и инварианты:
> [модель данных](data-model.md), [отрисованные ERD](diagrams/rendered/index.html).
